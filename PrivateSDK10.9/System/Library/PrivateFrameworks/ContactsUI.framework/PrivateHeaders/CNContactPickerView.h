...
@class ABBookSearchField, CNContactListView, CNContactPickerBorderView, CNContactPickerViewLayout, CNGroupListBackgroundView, CNGroupListView, NSArray, NSMutableDictionary, NSScrollView;
