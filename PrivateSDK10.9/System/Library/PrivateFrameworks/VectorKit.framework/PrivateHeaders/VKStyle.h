...
- (unsigned long long)scoreForAttributes:(id)arg1 vectorType:(long long)arg2 mapDisplayStyle:(long long)arg3 iconTappable:(BOOL)arg4 locale:(id)arg5;
...
- (id)contents;
- (BOOL)isForMapDisplayStyle:(long long)arg1 exclusively:(BOOL)arg2;
