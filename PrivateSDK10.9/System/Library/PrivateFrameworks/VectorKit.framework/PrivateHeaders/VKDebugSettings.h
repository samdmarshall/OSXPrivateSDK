...
@property(nonatomic) BOOL forceDepthDependentBuildings; // @synthesize forceDepthDependentBuildings=_forceDepthDependentBuildings;
...
@property(nonatomic) BOOL useOldLabels; // @synthesize useOldLabels=_useOldLabels;
