...
- (void)getRoadSignStyle:(CDStruct_32f014a0 *)arg1 atZoom:(float)arg2 tilt:(float)arg3 contentScale:(float)arg4 scaleFactor:(long long)arg5;
- (void)getNavShieldStyle:(CDStruct_32f014a0 *)arg1 atZoom:(float)arg2 tilt:(float)arg3 contentScale:(float)arg4 scaleFactor:(long long)arg5;
