...
{
    struct dispatch_queue_s *_postQueue;
    struct dispatch_queue_s *_findQueue;
    CalAccumulatingQueue *_alarmScan;
    CalAccumulatingQueue *_eventScan;
}

+ (id)defaultHelper;
+ (void)initialize;
- (void)debugFireAlarm:(id)arg1 withTriggerDate:(id)arg2;
- (void)hideAllDayEventsChanged:(id)arg1;
...
- (BOOL)_shouldEventBeShown:(id)arg1 forOccurrenceDate:(id)arg2;
...
- (id)_dateToDeliverEvent:(id)arg1;
...
- (void)_deleteEvents:(id)arg1;
- (void)deleteEvents:(id)arg1;
- (void)_removeOldEvents;
- (void)_deliverEvents:(id)arg1 withRemoveOld:(BOOL)arg2;
- (void)deliverEvents:(id)arg1;
- (void)_findAndDeliverUpcomingEvents:(id)arg1;
- (void)findAndDeliverUpcomingEvents:(id)arg1;
