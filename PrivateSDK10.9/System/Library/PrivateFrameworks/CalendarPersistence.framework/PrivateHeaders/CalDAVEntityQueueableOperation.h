...
@property(retain) CalCalDAVCalendarSource *source; // @synthesize source=_source;
- (void)configureOperationDependencies;
- (void)queueAttachmentOperations:(id)arg1 event:(id)arg2;
- (void)dealloc;
- (void)setError:(id)arg1 withResponseStatus:(id)arg2 forEntity:(id)arg3;
...
- (id)initWithChangeRequest:(id)arg1 fromSource:(id)arg2;
- (id)initWithChangeRequest:(id)arg1 fromPrincipal:(id)arg2;
