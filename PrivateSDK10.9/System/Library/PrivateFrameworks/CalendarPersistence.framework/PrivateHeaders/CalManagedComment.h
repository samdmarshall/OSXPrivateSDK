...
@class CalManagedCalendarItem, CalManagedICSElementProperties, NSDate, NSString, NSURL;

@interface CalManagedComment : CalManagedObject <CalManagedICSPropertyProtocol, StoresUnrecognizedICS>
{
}
