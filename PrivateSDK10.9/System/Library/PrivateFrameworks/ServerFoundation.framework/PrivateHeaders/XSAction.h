...
+ (id)action;
@property(readonly) NSArray *finishRecoveryCallbacks; // @synthesize finishRecoveryCallbacks=_finishRecoveryCallbacks;
@property(readonly) NSArray *finishCallbacks; // @synthesize finishCallbacks=_finishCallbacks;
@property(readonly) NSArray *errorCallbacks; // @synthesize errorCallbacks=_errorCallbacks;
@property(readonly) NSArray *cancelCallbacks; // @synthesize cancelCallbacks=_cancelCallbacks;
@property(readonly) NSArray *beginCallbacks; // @synthesize beginCallbacks=_beginCallbacks;
