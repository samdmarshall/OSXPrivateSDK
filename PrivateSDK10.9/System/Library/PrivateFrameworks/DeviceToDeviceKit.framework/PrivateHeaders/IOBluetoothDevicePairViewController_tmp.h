...
@interface IOBluetoothDevicePairViewController_tmp : NSViewController
{
    ...
    IOBluetoothPasskeyDisplay_tmp *_passkeyDisplay;
    BOOL _useCustomPINCode;
    NSString *_PINCode;
    IOBluetoothDevicePairViewControllerExpansion_tmp *_expansion;
}
...
- (id)pairingDelegate;
- (int)pairingWithDevice:(id)arg1 usingPincode:(id)arg2;
- (int)pairingWithDevice:(id)arg1;
