...
- (void)setWiFiLoggingEnabled:(BOOL)arg1 authorizationData:(NSData *)arg2 reply:(void (^)(NSError *))arg3;
- (void)queryWiFiLoggingEnabledWithAuthorizationData:(NSData *)arg1 reply:(void (^)(NSError *, BOOL))arg2;
