...
#import "CalUILocationSearchManagerDelegate.h"
#import "CalUIPlacemarkRequesterProtocol.h"
#import "MKSearchCompleterDelegate.h"
#import "NSTextFieldDelegate.h"
#import "NSTokenFieldDelegate.h"

@class CLPlacemark, CalAutoCompleteOperation, CalLocation, CalManagedAccount, CalUILocation, CalUILocationCompletionController, CalUILocationFieldContainer, CalUILocationSearchManager, MKLocalSearch, MKLocalSearchCompleter, NSFont, NSMutableArray, NSObject<CalUIControlResponder>, NSString;
...
@property(retain) CalManagedAccount *account; // @synthesize account=_account;
...
@property(retain) NSObject<CalUIControlResponder> *controlResponder; // @synthesize controlResponder=_controlResponder;
...
- (id)iconForLocationSuggestion:(id)arg1;
- (id)iconForRow:(long long)arg1;
...
- (void)_tellControlResponderTextDidChangeForControl:(id)arg1;
...
- (void)handleLocalSearchResponse:(id)arg1;
...
- (void)refreshSuggestionRowsWithCalDavLocations:(id)arg1 customLocations:(id)arg2 abLocations:(id)arg3 localSearchLocations:(id)arg4;
