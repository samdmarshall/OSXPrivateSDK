...
+ (void)_recalculateListenerCaps;
+ (void)removeListenerCaps:(unsigned int)arg1;
+ (void)addListenerCaps:(unsigned int)arg1;
+ (void)addListenerCapsMain:(unsigned int)arg1;
