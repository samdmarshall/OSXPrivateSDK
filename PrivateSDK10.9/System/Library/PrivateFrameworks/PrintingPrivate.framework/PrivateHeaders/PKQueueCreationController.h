...
@class NSArrayController, NSBox, NSDictionary, NSString, NSView, PKBrowser, PKDriver, PKNode, PMXPCSupport, PPInstallableOptionsView;
...
@property int suState; // @synthesize suState;
...
- (id)initForBrowsing:(id)arg1 delagate:(id)arg2;
