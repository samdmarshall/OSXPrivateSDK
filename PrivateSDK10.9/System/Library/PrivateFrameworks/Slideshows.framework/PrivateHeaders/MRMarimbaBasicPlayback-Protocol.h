...
@class MPDocument, MRRenderer, MRTouchSet;
...
- (void)lockRendering;
- (void)touchesCancelled:(MRTouchSet *)arg1;
- (BOOL)touchesEnded:(MRTouchSet *)arg1;
- (void)touchesMoved:(MRTouchSet *)arg1;
- (void)touchesBegan:(MRTouchSet *)arg1;
- (void)warmupRenderer;
