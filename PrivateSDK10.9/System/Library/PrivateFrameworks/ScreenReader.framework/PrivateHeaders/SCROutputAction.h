...
@class NSMutableDictionary, NSString, SCRCIndexMap, SCROffsetMappedString;

@interface SCROutputAction : NSObject <NSCopying>
{
    NSString *_category;
    NSString *_component;
    int _message;
    ...
    NSMutableDictionary *_notificationEvents;
...
- (void)setEvent:(id)arg1 forNotification:(id)arg2;
