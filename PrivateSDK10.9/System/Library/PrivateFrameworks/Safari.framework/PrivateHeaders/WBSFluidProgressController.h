...
@interface WBSFluidProgressController : NSObject
{
    ...
    struct RetainPtr<NSImage> _windowSnapshotA;
    struct RetainPtr<NSImage> _windowSnapshotB;
    BOOL _useWindowSnapshotBNextTime;
    NSTimer *_snapshotTimer;
}

@property id <WBSFluidProgressRocketEffectDelegate> rocketTestDelegate; // @synthesize rocketTestDelegate=_rocketTestDelegate;
