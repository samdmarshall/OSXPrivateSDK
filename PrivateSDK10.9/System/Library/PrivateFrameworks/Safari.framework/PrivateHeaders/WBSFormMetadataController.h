...
- (void)getFormID:(double *)arg1 andFieldName:(id *)arg2 forTextField:(id)arg3 inFrame:(id)arg4;
...
- (void)replaceRange:(struct _NSRange)arg1 inField:(id)arg2 form:(double)arg3 inFrame:(id)arg4 withString:(id)arg5 andSelectTailStartingAt:(unsigned long long)arg6;
