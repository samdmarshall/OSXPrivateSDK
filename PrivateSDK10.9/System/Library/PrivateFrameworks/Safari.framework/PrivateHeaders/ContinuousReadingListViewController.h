...
@class ContinuousAutomaticReadingListDataSource, ContinuousReadingListDataSource, NSArray, NSMutableDictionary;
...
- (void)addGlobalHistoryOperation:(id)arg1 forPage:(struct Page)arg2;
- (BOOL)shouldIgnoreGlobalHistoryForAboutBlankForPage:(struct Page)arg1;
...
- (void)dealloc;
@property(readonly, nonatomic) NSArray *allWKViews;
- (void)close;
