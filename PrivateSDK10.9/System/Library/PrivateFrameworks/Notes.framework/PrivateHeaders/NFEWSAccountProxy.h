...
@class EWSExchangeServiceBinding, NSMutableDictionary, NSOperationQueue, NSString, NSURL;

@interface NFEWSAccountProxy : NFAccountProxy <EWSExchangeServiceBindingDelegate>
{
...
- (BOOL)hasNotes;
- (id)_fetchDistinguishedFolderInfo:(int)arg1 error:(id *)arg2;
...
- (void)_createOrUpdateFolder:(id)arg1;
...
- (void)_nfEWSAccountProxyCommonInit;
- (id)init;
