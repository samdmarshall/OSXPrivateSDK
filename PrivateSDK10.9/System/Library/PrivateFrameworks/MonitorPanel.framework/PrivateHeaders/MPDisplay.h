...
@class MPDisplayMode, NSArray, NSMutableArray, NSMutableDictionary, NSString, NSUUID;
...
@property(readonly) NSArray *resolutions;
...
@property(readonly) NSArray *userModes;
@property(readonly) NSArray *allModes;
...
@property BOOL showPreferredModesOnly;
- (void)refreshModes;
- (void)refreshResolutions;
- (id)scanRateForString:(id)arg1;
- (id)stringForScanRate:(id)arg1;
- (void)refreshScanRates;
- (void)determinePreferredModes;
- (void)addMatchingModesToPreferred;
