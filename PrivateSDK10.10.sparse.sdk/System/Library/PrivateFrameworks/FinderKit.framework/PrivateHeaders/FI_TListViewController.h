...
- (void)updateCustomCellColorAppearance:(id)arg1 forColumn:(id)arg2 selected:(_Bool)arg3 key:(_Bool)arg4 forNode:(const struct TFENode *)arg5;
- (id)customColorCellValue:(id)arg1 selected:(_Bool)arg2 key:(_Bool)arg3 forNode:(const struct TFENode *)arg4;
- (id)colorForCellColumn:(id)arg1 selected:(_Bool)arg2 key:(_Bool)arg3 forNode:(const struct TFENode *)arg4;
