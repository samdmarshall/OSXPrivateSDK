...
@interface FIFinderSyncExtensionHost : NSExtensionContext <FIFinderSyncExtensionHostProtocol, NSMenuDelegate>
{
    ...
    struct unordered_map<TString, TNSRef<NSDictionary *>, std::__1::hash<TString>, std::__1::equal_to<TString>, std::__1::allocator<std::__1::pair<const TString, TNSRef<NSDictionary *>>>> _badgeIDImageDicts;
...
- (id)badgeImageForIdentifier:(const struct TString *)arg1 size:(double)arg2;
