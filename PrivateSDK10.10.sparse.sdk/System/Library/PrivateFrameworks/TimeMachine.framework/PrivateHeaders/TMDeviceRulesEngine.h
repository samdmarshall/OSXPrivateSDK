...
@class MDSPathFilter, TMDisk, TMSpotlightOracle;

@interface TMDeviceRulesEngine : NSObject
{
    TMDisk *_disk;
    MDSPathFilter *_tmPathFilter;
...
@property(readonly) MDSPathFilter *timeMachineFilter; // @synthesize timeMachineFilter=_tmPathFilter;
...
- (BOOL)_rawPathIsUndiscoveredStickyExclusion:(const char *)arg1;
- (BOOL)_rawPathIsFile:(const char *)arg1 hints:(struct _TMRulesQueryHints *)arg2;
- (BOOL)_rawPathIsExcluded:(const char *)arg1 filterRules:(CDStruct_b7969f8e)arg2 hints:(struct _TMRulesQueryHints *)arg3 details:(struct _TMRulesQueryDetails *)arg4;
...
- (void)dealloc;
- (id)initWithDisk:(id)arg1 timeMachineFilter:(id)arg2 spotlightOracle:(id)arg3;
