...
@class DeltaSnapshotInfo, FSPath, NSDictionary, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSSet, NSString, VolumeInfo, XattrAppleDouble;
...
- (id)_deltaPathOfActualItemForSubPath:(id)arg1 lookingForwardFromSnapshot:(id)arg2;
...
- (void)updateSizeForSnapshot:(id)arg1 addEstimate:(long long)arg2;
...
- (id)findDateOfSnapshotNamed:(id)arg1 preferXattr:(BOOL)arg2;
