...
#import "SOAccountInfoHelperReceiverProtocol-Protocol.h"
...
- (id)runBlock:(id)arg1 onIMessageIDChange:(void)arg2;
- (id)runBlock:(id)arg1 onFaceTimeIDChange:(void)arg2;
- (id)_runBlock:(id)arg1 onIDChange:(void)arg2 withStorage:(id)arg3;
