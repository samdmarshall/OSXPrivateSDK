...
#import "ACSHPanelElementViewContainer-Protocol.h"
...
- (void)performBlockOnViewAndAncestors:(id)arg1;
- (void)performBlockOnAncestors:(id)arg1;
- (void)_performBlockOnAncestors:(id)arg1 includeSelf:(void)arg2;
- (void)performBlockOnDescendents:(id)arg1;
- (void)performBlockOnViewAndDescendents:(id)arg1;
- (void)_performBlockOnDescendents:(id)arg1 includeSelf:(void)arg2;
