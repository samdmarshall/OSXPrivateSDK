...
@interface ISStoreURLOperation : ISURLOperation
{
    ...
    id _authenticationCompletedHandler;
    id _requestMutationHandler;
...
@property(copy) id requestMutationHandler; // @synthesize requestMutationHandler=_requestMutationHandler;
@property(copy) id authenticationCompletedHandler; // @synthesize authenticationCompletedHandler=_authenticationCompletedHandler;
