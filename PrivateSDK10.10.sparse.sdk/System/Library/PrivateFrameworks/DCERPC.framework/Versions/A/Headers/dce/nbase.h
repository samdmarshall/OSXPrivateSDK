...
#define dce_c_rpc_authn_protocol_gss_negotiate (9)
#define dce_c_rpc_authn_protocol_winnt (10)
#define dce_c_rpc_authn_protocol_gss_tls (14)
#define dce_c_rpc_authn_protocol_gss_mskrb (16)
#define dce_c_rpc_authn_protocol_msn (17)
#define dce_c_rpc_authn_protocol_dpa (18)
#define dce_c_rpc_authn_protocol_netlogon (68)
#define dce_c_rpc_authn_protocol_schannel (68)
