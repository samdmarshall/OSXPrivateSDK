...
@property(copy, nonatomic) id syncHandler; // @synthesize syncHandler=_syncHandler;
@property(copy, nonatomic) id getAccountPropertiesHandler; // @synthesize getAccountPropertiesHandler=_getAccountPropertiesHandler;
