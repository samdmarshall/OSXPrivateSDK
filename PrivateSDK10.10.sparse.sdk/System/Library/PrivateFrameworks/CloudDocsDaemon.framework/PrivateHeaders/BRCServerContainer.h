...
@class BRCAccountSession, BRCLocalContainer, CKContainer, CKDatabase, CKOperation, CKServerChangeToken, NSArray, NSDate, NSDictionary, NSError, NSString, PQLConnection, PQLNameInjection;
...
@interface BRCServerContainer : NSObject <BRCContainer>
{
    ...
    CKOperation *_deleteAllContentsOperation;
...
@property(readonly, nonatomic) CKOperation *deleteAllContentsOperation;
