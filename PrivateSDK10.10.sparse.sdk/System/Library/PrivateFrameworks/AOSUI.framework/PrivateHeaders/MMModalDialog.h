...
- (long long)beginSheetModalForWindow:(id)arg1 completionHandler:(id)arg2;
- (void)beginModalDialogWithParentWindow:(id)arg1 shouldNest:(BOOL)arg2 completionHandler:(id)arg3;
- (void)beginModalDialogWithParentWindow:(id)arg1 completionHandler:(id)arg2;
- (void)dealloc;
- (id)initWithTitle:(id)arg1 message:(id)arg2 defaultButtonTitle:(id)arg3 alternateButtonTitle:(id)arg4 otherButtonTitle:(id)arg5 icon:(id)arg6 badge:(id)arg7 helpHandler:(id)arg8;
