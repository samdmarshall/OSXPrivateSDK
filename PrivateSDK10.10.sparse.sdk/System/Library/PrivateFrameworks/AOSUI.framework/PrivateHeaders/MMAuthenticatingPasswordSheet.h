...
@property(copy) id helpHandler; // @synthesize helpHandler=_helpHandler;
...
- (void)showPasswordSheetUsingWindow:(id)arg1 shouldNest:(BOOL)arg2 helpHandler:(id)arg3 completionHandler:(void)arg4;
