...
@class CombinedFavoritesGridViewController, KeyLoopSplicingContainerView, NSArray, NSLayoutConstraint, NSSegmentedControl, NSString, NSView, NSViewController<StartPageContentViewController>, TestDriveMigrationBannerViewController, TopSitesViewController;
...
- (void)_reLayOutThenRunAnimationGroup:(id)arg1;
