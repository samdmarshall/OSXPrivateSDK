...
- (id)_redoMoveBookmarksWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 undoPreflightBlock:(id)arg4 undoCompletionBlock:(void)arg5;
- (id)_undoMoveBookmarksWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 redoPreflightBlock:(id)arg4 redoCompletionBlock:(void)arg5;
- (id)_undoMoveBookmarks:(id)arg1;
- (void)_redoNewBookmarkWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 undoPreflightBlock:(id)arg4 undoCompletionBlock:(void)arg5;
- (void)_undoNewBookmarkWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 redoPreflightBlock:(id)arg4 redoCompletionBlock:(void)arg5;
...
- (void)redoMoveBookmarksWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 undoPreflightBlock:(id)arg4 undoCompletionBlock:(void)arg5;
- (void)undoMoveBookmarksWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 redoPreflightBlock:(id)arg4 redoCompletionBlock:(void)arg5;
- (void)redoNewBookmarkWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 undoPreflightBlock:(id)arg4 undoCompletionBlock:(void)arg5;
- (void)undoNewBookmarkWithUndoInfo:(id)arg1 preflightBlock:(id)arg2 completionBlock:(void)arg3 redoPreflightBlock:(id)arg4 redoCompletionBlock:(void)arg5;
...
- (void)performUndoCompatibleBookmarksChangeWithActionName:(id)arg1 inBlock:(id)arg2;
- (void)performUndoCompatibleBookmarksChangeInBlock:(id)arg1;
