...
- (id)_redoMoveCompletionBlock;
- (id)_redoMovePreflightBlock;
- (void)undoMoveBookmarks:(id)arg1;
- (id)_undoMoveCompletionBlock;
- (id)_undoMovePreflightBlock;
- (void)undoNewBookmark:(id)arg1;
- (id)_undoNewBookmarkCompletionBlockForUndoInfo:(SEL)arg1;
- (id)_undoNewBookmarkPreflightBlock;
...
- (id)_redoNewBookmarkCompletionBlockForUndoInfo:(SEL)arg1;
- (id)_redoNewBookmarkPreflightBlock;
