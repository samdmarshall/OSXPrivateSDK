...
@class AKLineStylesViewController, AKTextAttributesViewController, AKToolbarButtonItem_Mac, AKToolbarColorWellItem_Mac, NSMenu, NSPopover, NSString, NSView, NSWindow;
...
@interface AKToolbarViewController_Mac : AKToolbarViewController <NSPopoverDelegate>
{
    ...
    AKToolbarButtonItem_Mac *_sketchButton;
...
@property(retain) AKLineStylesViewController *lineStylesViewController; // @synthesize lineStylesViewController=_lineStylesViewController;
...
@property(retain) NSView *sketchButton; // @synthesize sketchButton=_sketchButton;
