...
+ (id)sharedInstance;
- (BOOL)requestIDStatusForDestination:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
- (BOOL)requestIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
