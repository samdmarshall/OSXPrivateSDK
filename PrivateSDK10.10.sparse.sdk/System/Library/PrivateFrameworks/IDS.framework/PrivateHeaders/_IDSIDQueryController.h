...
- (BOOL)currentIDStatusForDestination:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
- (BOOL)currentIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
- (BOOL)refreshIDStatusForDestination:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
- (BOOL)refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 queue:(struct dispatch_queue_s *)arg4 completionBlock:(id)arg5;
- (BOOL)_refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 allowRefresh:(BOOL)arg4 queue:(struct dispatch_queue_s *)arg5 completionBlock:(id)arg6;
...
- (void)___oldDealloc;
- (void *)__sendMessage:(void *)arg1 queue:(struct dispatch_queue_s *)arg2 reply:(id)arg3 failBlock:(void)arg4 waitForReply:(id)arg5;
