...
@class AVPlayer, AVURLAsset, NSArray, NSMutableArray, NSTextField, NSTrackingArea, NSURL, NSView, PPGesture, PPGestureRow, PPGestureView;
...
@interface PPGestureViewController : NSObject
{
    ...
    float mInterRowSpacing;
    BOOL mUseNewUI;
    id mChapterPlaybackCompleteBlock;
    id mUserDidSelectGestureBlock;
}
...
- (void)setUserDidSelectGestureBlock:(id)arg1;
- (void)setPlaybackCompleteBlock:(id)arg1;
...
- (void)showWarningForGesture:(id)arg1 show:(BOOL)arg2;
...
- (void)setInterRowSpacing:(float)arg1;
...
- (void)_hideWarningForRow:(id)arg1;
