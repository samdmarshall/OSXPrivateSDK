...
- (id)observerOSUpdateProgressWithProgressHandler:(id)arg1;
- (void)stopObservingOSUpdateScansWithCallback:(id)arg1;
- (id)observerOSUpdateScansWithProgressHandler:(id)arg1;
...
- (void)startAppUpdates:(id)arg1 andOSUpdates:(id)arg2 withDelegate:(id)arg3 completionHandler:(id)arg4;
- (void)checkForUpdatesWithUserHasSeenUpdates:(BOOL)arg1 completionHandler:(id)arg2;
- (void)removeAvailableUpdatesObserver:(id)arg1;
- (id)addAvailableUpdatesObserverWithBlock:(id)arg1;
