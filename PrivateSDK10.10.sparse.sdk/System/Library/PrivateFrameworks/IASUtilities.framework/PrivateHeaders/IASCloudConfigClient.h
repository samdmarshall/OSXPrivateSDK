...
- (id)requestInstallationWithUUID:(id)arg1 profileData:(id)arg2 timeout:(double)arg3 reply:(id)arg4;
- (id)requestProfileWithAuthorization:(id)arg1 timeout:(double)arg2 reply:(id)arg3;
- (id)requestActivationStatusWithTimeout:(double)arg1 reply:(id)arg2;
- (void)dealloc;
- (id)init;
