...
#import "DefaultAlarmProviderProtocol-Protocol.h"
#import "EKProtocolCalendar-Protocol.h"
...
- (id)calendarSource;
- (void)asyncImportFiles:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 processEvents:(BOOL)arg4 processReminders:(BOOL)arg5 callbackQueue:(id)arg6 progressBlock:(id)arg7 abortForIssueBlock:(void)arg8 finishBlock:(id)arg9;
- (void)asyncImportICSDocument:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 processEvents:(BOOL)arg4 processReminders:(BOOL)arg5 callbackQueue:(id)arg6 progressBlock:(id)arg7 abortForIssueBlock:(void)arg8 finishBlock:(id)arg9;
- (void)blockingImportICSDocument:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 processEvents:(BOOL)arg4 processReminders:(BOOL)arg5 progressBlock:(id)arg6 abortForIssueBlock:(void)arg7 finishBlock:(id)arg8;
- (BOOL)importICSDocument:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 processEvents:(BOOL)arg4 processReminders:(BOOL)arg5 callbackQueue:(id)arg6 progressBlock:(id)arg7 abortForIssueBlock:(void)arg8 finishBlock:(id)arg9 shouldSaveOnSuccess:(void)arg10 synchronousFinishBlock:(id)arg11;
- (BOOL)importICSDocument:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 processEvents:(BOOL)arg4 processReminders:(BOOL)arg5 callbackQueue:(id)arg6 progressBlock:(id)arg7 abortForIssueBlock:(void)arg8 finishBlock:(id)arg9;
- (BOOL)_importCleanedDocument:(id)arg1 importOptionsForInsert:(unsigned long long)arg2 importOptionsForUpdate:(unsigned long long)arg3 sharedUIDsToImport:(id)arg4 objectIDsImported:(id)arg5 progressBlock:(id)arg6 abortForIssueBlock:(void)arg7;
