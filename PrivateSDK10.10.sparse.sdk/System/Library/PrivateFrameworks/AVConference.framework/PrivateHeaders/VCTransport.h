...
- (void)registerDataReceivedHandler:(id)arg1 forCallID:(void)arg2;
...
- (void)registerICEBlockForCallID:(unsigned int)arg1 connectedBlock:(id)arg2 newCandidatesBlock:(void)arg3 setupRelayBlock:(id)arg4;
- (void)dealloc;
- (id)init;
