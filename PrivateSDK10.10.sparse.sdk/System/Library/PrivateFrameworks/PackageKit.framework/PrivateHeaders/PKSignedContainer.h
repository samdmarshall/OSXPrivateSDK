...
- (id)startUnarchivingAtPath:(id)arg1 notifyOnQueue:(struct dispatch_queue_s *)arg2 progress:(id)arg3 finish:(void)arg4;
- (void)_startUnarchivingAtPath:(id)arg1 cancelHandler:(id)arg2 notifyOnQueue:(struct dispatch_queue_s *)arg3 progress:(id)arg4 finish:(void)arg5;
