...
@interface PKPayloadCopier : NSObject
{
    ...
    NSArray *_maskPaths;
    id _itemWillCopyHandler;
    id _itemCopiedHandler;
...
- (void)setItemWillCopyHandlerWithBlock:(id)arg1;
- (void)setItemCopiedHandlerOnQueue:(struct dispatch_queue_s *)arg1 withBlock:(id)arg2;
