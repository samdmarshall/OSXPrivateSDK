...
@class IMAPGateway, IMAPMailbox, MCInvocationQueue, NSArray, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSMutableSet, NSString;
...
@property(readonly, copy, nonatomic) id compareByUid;
