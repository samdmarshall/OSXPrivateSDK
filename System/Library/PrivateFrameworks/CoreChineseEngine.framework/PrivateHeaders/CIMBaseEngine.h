...
@class CIMCandidateSorter, CIMInputController, NSArray, NSString;
...
@interface CIMBaseEngine : NSObject
{
    ...
    NSString *_savedCandidate;
    NSString *_previousCandidate;
...
@property(retain, nonatomic) NSString *previousCandidate; // @synthesize previousCandidate=_previousCandidate;
@property(retain, nonatomic) NSString *savedCandidate; // @synthesize savedCandidate=_savedCandidate;
