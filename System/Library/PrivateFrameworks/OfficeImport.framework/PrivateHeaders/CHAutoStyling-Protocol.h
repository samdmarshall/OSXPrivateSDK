...
- (void)resolveGraphicPropertiesOfErrorBar:(OADGraphicProperties *)arg1 forSeriesIndex:(unsigned long long)arg2 colorMap:(OADColorMap *)arg3 colorScheme:(OADColorScheme *)arg4;
- (void)resolveGraphicPropertiesOfTrendline:(OADGraphicProperties *)arg1 forSeriesIndex:(unsigned long long)arg2;
- (void)resolveGraphicPropertiesOfSeries:(OADGraphicProperties *)arg1 forSeriesIndex:(unsigned long long)arg2 isLine:(_Bool)arg3 colorMap:(OADColorMap *)arg4 colorScheme:(OADColorScheme *)arg5;
- (void)resolveGraphicPropertiesOfSeries:(OADGraphicProperties *)arg1 forSeriesIndex:(unsigned long long)arg2 colorMap:(OADColorMap *)arg3 colorScheme:(OADColorScheme *)arg4;
@end
