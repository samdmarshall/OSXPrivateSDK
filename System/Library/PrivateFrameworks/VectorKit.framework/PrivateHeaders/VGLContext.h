...
@class NSMapTable, NSMutableArray, NSString, VGLFramebuffer, VGLGPU, VGLMesh, VGLProgram, VGLProgramFactory, VGLRenderState, VGLResourceFactory, VGLSharegroup, VGLTexture, VGLVertexArrayObject;
...
@property(nonatomic) BOOL alphaTest; // @synthesize alphaTest=_alphaTest;
...
@property(readonly, nonatomic) struct _CGLPixelFormatObject *cglPixelFormat; // @synthesize cglPixelFormat=_cglPixelFormat;
@property(readonly, nonatomic) struct _CGLContextObject *cglContext; // @synthesize cglContext=_cglContext;
...
- (void)setAlphaFunc:(int)arg1 ref:(float)arg2;
