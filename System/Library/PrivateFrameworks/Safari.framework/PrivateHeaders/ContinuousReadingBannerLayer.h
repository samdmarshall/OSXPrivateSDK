...
@property(readonly, nonatomic) CALayer *retweetButtonLayer;
@property(readonly, nonatomic) CALayer *screenNameAndRetweetInfoTextLayer;
@property(readonly, nonatomic) CALayer *secondaryTextLayer;
@property(readonly, nonatomic) CALayer *primaryTextLayer;
@property(readonly, nonatomic) CALayer *secondaryIconImageLayer;
@property(readonly, nonatomic) CALayer *primaryIconImageLayer;
