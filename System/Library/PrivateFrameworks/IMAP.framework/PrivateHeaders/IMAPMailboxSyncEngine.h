...
@class IMAPGateway, IMAPMailbox, MCInvocationQueue, NSArray, NSMutableArray, NSMutableIndexSet;
...
@interface IMAPMailboxSyncEngine : NSObject <IMAPFetchResponseHandler, MCActivityTarget>
{
    ...
    NSMutableArray *_labelFetchOperations;
    id _syncEngineLock;
    ...
    NSMutableIndexSet *_messageUIDsNeedingLabels;
    ...
    BOOL _shouldLogIMAPMailboxSyncEngineActivity;
...
@property unsigned long long allegedHighestModificationSequence; // @synthesize allegedHighestModificationSequence=_allegedHighestModificationSequence;
...
- (BOOL)_fetchLabelsWithMonitor:(id)arg1;
...
- (void)_pushLabels:(id)arg1 toDataSource:(id)arg2 withMonitor:(id)arg3 messagesToRoute:(id *)arg4;
...
@property(readonly) CDUnknownBlockType compareByUid;
