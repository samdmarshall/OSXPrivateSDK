...
@property(readonly) NSRemoteServiceConnection *connection; // @synthesize connection=_connection;
@property BOOL isSheet; // @synthesize isSheet=_isSheet;
@property id delegate; // @synthesize delegate=_delegate;
@property(readonly) NSPanel *window; // @synthesize window=_localProxyWindow;
