...
- (void)promptUserForCredentialsWithAccount:(id)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)renewCredentialsForAccount:(id)arg1 accountStore:(id)arg2 force:(BOOL)arg3 reason:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)credentialForAccount:(id)arg1 client:(id)arg2 handler:(CDUnknownBlockType)arg3;
