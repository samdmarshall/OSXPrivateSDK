...
@class NSColor, NSDate, NSFont, NSMenuItem, NSNumber, NSString, NSView, SOInputLineAutoSender, SOTimer, SOTimerCenter;
...
@interface SOInputLine : NSTextView
{
    ...
    _Bool _delegateRespondsToDefaultTypingAttributesForInputLine;
