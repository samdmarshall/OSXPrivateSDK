...
+ (BOOL)restorePersistentStoreInManagedObjectContext:(id)arg1 inBatches:(BOOL)arg2 error:(id *)arg3;
+ (BOOL)restorePersistentStoreInManagedObjectContext:(id)arg1 error:(id *)arg2;
+ (BOOL)hasTruthFiles;
...
+ (id)handleDuplicatesAndReturnUniques:(id)arg1 inCalendars:(id)arg2;
