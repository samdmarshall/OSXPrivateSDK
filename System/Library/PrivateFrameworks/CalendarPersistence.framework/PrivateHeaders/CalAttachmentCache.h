...
+ (id)etagFileNameAtIndex:(unsigned long long)arg1 inEntityWithSharedUID:(id)arg2 source:(id)arg3;
+ (unsigned long long)etagEntriesForEntityWithSharedUID:(id)arg1 source:(id)arg2;
+ (void)setEtag:(id)arg1 forAttachment:(id)arg2 inEntityWithSharedUID:(id)arg3 source:(id)arg4;
+ (id)etagForAttachment:(id)arg1 inEntityWithSharedUID:(id)arg2 source:(id)arg3;
+ (id)_etagCacheForEntityAttachmentsSharedUID:(id)arg1 source:(id)arg2;
+ (BOOL)moveCacheDirectoryForEntityWithSharedUID:(id)arg1 fromSource:(id)arg2 toSource:(id)arg3;
+ (BOOL)addAttachment:(id)arg1 toEntityWithSharedUID:(id)arg2 source:(id)arg3;
...
+ (id)cacheDirectoryForAttachmentsInEntityWithSharedUID:(id)arg1 source:(id)arg2;
