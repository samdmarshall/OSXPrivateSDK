...
- (id)summary;
- (id)commitWithDelegate:(id)arg1 withUndoString:(id)arg2 commitWholeRecurrence:(BOOL)arg3 inManagedObjectContext:(id)arg4;
- (id)commitWithDelegate:(id)arg1 withUndoString:(id)arg2 inManagedObjectContext:(id)arg3;
