...
@class CalCalDAVCalendarSource, CalManagedCalDAVCalendar, CalManagedCalDAVPrincipal, NSMutableDictionary, NSMutableSet;

@interface CalCalDAVContainerSyncTaskGroupWrapper : CalCalDAVSynchronousTaskGroup <CalDAVChecksumLocalDBInfoProvider>
{
    CalManagedCalDAVPrincipal *_principal;
    CalManagedCalDAVCalendar *_calendar;
    CalCalDAVCalendarSource *_calendarSource;
...
@property(retain, nonatomic) CalCalDAVCalendarSource *calendarSource; // @synthesize calendarSource=_calendarSource;
...
- (id)messageTraceSignatureForServerURL:(id)arg1;
