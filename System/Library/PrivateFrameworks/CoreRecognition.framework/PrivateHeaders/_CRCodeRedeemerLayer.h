...
@interface _CRCodeRedeemerLayer : CRCodeRedeemerLayer <AVCaptureVideoDataOutputSampleBufferDelegate>
{
    ...
    id <CRCodeRedeemerLayerDelegate> _delegate;
...
@property(nonatomic) BOOL isCaptureModeOnly; // @synthesize isCaptureModeOnly=_isCaptureModeOnly;
