...
@property(readonly, nonatomic) CDStruct_9b775316 *pois; // @synthesize pois=_pois;
...
@property(readonly, nonatomic) CDStruct_4c710163 *threeDBuildings; // @synthesize threeDBuildings=_threeDBuildings;
...
@property(readonly, nonatomic) CDStruct_d53c8792 *hiResBuildingFootprints; // @synthesize hiResBuildingFootprints=_hiResBuildingFootprints;
...
@property(readonly, nonatomic) CDStruct_d53c8792 *buildingFootprints; // @synthesize buildingFootprints=_buildingFootprints;
@property(readonly, nonatomic) unsigned long long polygonsCount; // @synthesize polygonsCount=_polygonsCount;
@property(readonly, nonatomic) CDStruct_a4767fdf *polygons; // @synthesize polygons=_polygons;
@property(readonly, nonatomic) unsigned long long coastlinesCount; // @synthesize coastlinesCount=_coastlinesCount;
@property(readonly, nonatomic) CDStruct_730d2803 *coastlines; // @synthesize coastlines=_coastlines;
@property(readonly, nonatomic) unsigned long long linesCount; // @synthesize linesCount=_linesCount;
@property(readonly, nonatomic) CDStruct_730d2803 *lines; // @synthesize lines=_lines;
- (CDStruct_730d2803 *)multiSectionFeatureForGeoID:(unsigned long long)arg1;
...
- (void)forEachJunctionInRoad:(CDStruct_730d2803 *)arg1 visitor:(CDUnknownBlockType)arg2;
- (void)forEachEdgeInRoad:(CDStruct_730d2803 *)arg1 visitTwice:(BOOL)arg2 visitor:(CDUnknownBlockType)arg3;
...
- (BOOL)_readHiResBuildings:(CDStruct_effb527d *)arg1;
...
- (BOOL)_readInfoChapter:(CDStruct_effb527d *)arg1;
