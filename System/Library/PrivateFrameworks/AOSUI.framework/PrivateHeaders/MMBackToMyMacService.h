...
- (void)willUnselect;
- (void)willSelect;
- (void)showSheetForWindow:(id)arg1 title:(id)arg2 message:(id)arg3 defaultButtonTitle:(id)arg4 alternateButtonTitle:(id)arg5 otherButtonTitle:(id)arg6 icon:(id)arg7 andHelpHandler:(CDUnknownBlockType)arg8 completionHandler:(CDUnknownBlockType)arg9;
