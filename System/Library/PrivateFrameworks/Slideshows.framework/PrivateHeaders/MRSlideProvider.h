...
@class MCSlide, MRAssetPlayer, MRFrame, MRImage, MRLayer, MRLayerEffect, NSDictionary, NSInvocationOperation, NSLock, NSString;
...
@property(readonly) double slideDuration; // @synthesize slideDuration=mSlideDuration;
@property(readonly) double slideStartTime; // @synthesize slideStartTime=mSlideStartTime;
