...
@class CalUIAXMiniMonthProxy, CalUIMiniMonthViewFormatter, NSArray, NSButton, NSCalendar, NSDate, NSMutableArray, NSTextField, NSTrackingArea;
...
@property id <CalUIMiniMonthViewDelegate> delegate; // @synthesize delegate=_delegate;
