...
@class CALayer, NSArray, NSCursor, NSImage, NSMutableDictionary, NSPasteboard, NSTrackingArea, SSFrameBuffer;
...
- (id)genericDocumentIconForDragWithItemCount:(unsigned int)arg1;
...
@property(retain, nonatomic) NSCursor *cursor; // @dynamic cursor;
