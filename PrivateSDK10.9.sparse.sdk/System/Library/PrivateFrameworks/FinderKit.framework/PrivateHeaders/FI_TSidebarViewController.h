...
@class FI_TBrowserContainerController, FI_TSidebarView, NSMutableArray, NSMutableIndexSet;
...
+ (void)actionButtonCoreUIOrLegacyImage:(int)arg1 highlighted:(_Bool)arg2 mouseState:(int)arg3 coreUIName:(const struct __CFString **)arg4 appKitImageName:(id *)arg5 color:(struct TColor *)arg6 legacyImageID:(long long *)arg7 animate:(char *)arg8 scaleFactor:(double)arg9;
