...
+ (void)handleContextMenuCommon:(unsigned int)arg1 nodes:(const struct TFENodeVector *)arg2 event:(id)arg3 clickedView:(id)arg4 browserViewController:(id)arg5 addPlugIns:(BOOL)arg6;
+ (void)buildContextMenu:(id)arg1 forContext:(unsigned int)arg2 browserViewController:(id)arg3 clickedView:(id)arg4 maxItems:(unsigned long long)arg5 addServices:(BOOL)arg6;
...
- (void)configureFromMenuNeedsUpdate:(id)arg1 clickedView:(id)arg2 container:(BOOL)arg3 event:(id)arg4 selectedNodes:(const struct TFENodeVector *)arg5;
- (void)dealloc;
