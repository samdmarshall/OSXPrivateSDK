...
- (void)addRoadForPolygon:(const Vec2Imp_1782d7e3 *)arg1 pointCount:(unsigned long long)arg2 characteristicPoints:(const CDStruct_dab2d0bd *)arg3 characteristicPointCount:(unsigned long long)arg4 withStyle:(id)arg5;
- (void)dealloc;
