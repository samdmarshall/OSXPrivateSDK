...
@class NSArray, NSError, VKLabelMarker, VKOverlayPainter;
...
- (void)map:(id <VKInteractiveMap>)arg1 didFinishAddingAnnotationMarkers:(NSArray *)arg2;
- (void)map:(id <VKInteractiveMap>)arg1 didAnimateInAnnotationMarkers:(NSArray *)arg2;
- (void)map:(id <VKInteractiveMap>)arg1 willAnimateInAnnotationMarkers:(NSArray *)arg2;
- (void)map:(id <VKInteractiveMap>)arg1 didAddAnnotationMarkers:(NSArray *)arg2;
...
- (void)mapDidStopRegionAnimation:(id <VKInteractiveMap>)arg1 completed:(BOOL)arg2;
- (void)mapWillStartRegionAnimation:(id <VKInteractiveMap>)arg1;
...
- (void)mapDidDraw:(id <VKInteractiveMap>)arg1;
