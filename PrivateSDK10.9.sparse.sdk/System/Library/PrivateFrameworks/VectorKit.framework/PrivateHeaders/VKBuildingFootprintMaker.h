...
- (void)_makeShadowTextureWithVectorTile:(id)arg1 skipLandmarks:(BOOL)arg2 pointyFootprints:(const unordered_map_93d329bc *)arg3 useHiResFootprints:(BOOL)arg4 landmarks:(const CDStruct_4c710163 *)arg5 landmarkCount:(unsigned long long)arg6;
- (BOOL)_makeThreeDBuildingsMesh:(const CDStruct_4c710163 *)arg1 buildingCount:(unsigned long long)arg2;
- (void)_makeMeshesWithLandmarksPresent:(BOOL)arg1 makeFacades:(BOOL)arg2 pointyFootprints:(unordered_map_93d329bc *)arg3 useHiResFootprints:(BOOL)arg4;
...
- (void)forEachTopStrokeMesh:(CDUnknownBlockType)arg1 forVectorType:(long long)arg2 atLayer:(unsigned int)arg3;
- (void)forEachTopMesh:(CDUnknownBlockType)arg1 forVectorType:(long long)arg2 atLayer:(unsigned int)arg3;
- (void)forEachTopMesh:(CDUnknownBlockType)arg1 topStrokeMesh:(CDUnknownBlockType)arg2 forVectorType:(long long)arg3;
