...
@property(nonatomic) ReaderWKView *readerWKView; // @synthesize readerWKView=_readerWKView;
...
- (void)activateWithAnimation:(BOOL)arg1 verticalScrollOffsetOfOfBrowserPage:(double)arg2;
- (void)dealloc;
