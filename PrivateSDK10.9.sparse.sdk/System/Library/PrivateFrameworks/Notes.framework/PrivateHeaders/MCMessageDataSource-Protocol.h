...
@class MCMessage, MCMessageBody, MCMessageHeaders, MCMimePart, MCResultTaskOperation, NSArray, NSColor, NSData, NSDictionary, NSOperation, NSString;
...
- (NSArray *)routeMessages:(NSArray *)arg1;
- (void)doCompact;
- (BOOL)canCompact;
