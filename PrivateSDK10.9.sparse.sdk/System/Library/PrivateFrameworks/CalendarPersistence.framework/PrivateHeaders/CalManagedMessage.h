...
@class CalManagedDiff, CalManagedEvent, CalManagedMessageContents, CalManagedPrincipal, NSData, NSDate, NSMutableSet, NSNumber, NSString;

@interface CalManagedMessage : CalManagedObject <ETagObject>
{
    NSString *_path;
