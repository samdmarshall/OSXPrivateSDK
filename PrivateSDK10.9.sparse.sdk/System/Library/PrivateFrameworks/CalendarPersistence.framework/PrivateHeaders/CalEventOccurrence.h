...
- (id)changedValues;
@property(readonly, nonatomic) NSDate *dateForSorting;
- (id)legacyOccurrence;
- (BOOL)isEditable;
...
- (id)repository;
@property(readonly, nonatomic) CoreCalendarSource *calendarSource;
...
@property(readonly, nonatomic) CalManagedCalendar *calendar;
- (BOOL)isValid;
...
- (id)commitWithDelegate:(id)arg1 withUndoString:(id)arg2 commitWholeRecurrence:(BOOL)arg3;
- (id)commitWithDelegate:(id)arg1 withUndoString:(id)arg2;
- (id)commitEditingWithDelegate:(id)arg1 undoString:(id)arg2;
- (id)commitEditing;
...
- (id)init;
- (id)_textRepresentationForAttendee:(id)arg1;
- (id)textRepresentationWithFormat:(int)arg1 showURI:(BOOL)arg2;
- (id)textRepresentationWithFormat:(int)arg1;
