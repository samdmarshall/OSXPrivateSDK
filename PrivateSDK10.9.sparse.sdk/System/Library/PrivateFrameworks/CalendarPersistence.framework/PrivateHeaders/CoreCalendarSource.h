...
- (void)modifyEntityForUndo:(id)arg1;
- (void)removeEntityForUndo:(id)arg1;
- (void)addEntityForUndo:(id)arg1;
- (id)objectForUndoWithEntity:(id)arg1 managedObjectContext:(id)arg2;
