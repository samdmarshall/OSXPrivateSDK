...
- (void)stopIDQueriesWithGUID:(id)arg1;
- (id)requestFaceTimeStatusForIDs:(id)arg1;
- (id)requestMessagesStatusForIDs:(id)arg1;
- (id)requestFaceTimeStatusForID:(id)arg1;
- (id)requestMessagesStatusForID:(id)arg1;
- (id)_generateGUID;
