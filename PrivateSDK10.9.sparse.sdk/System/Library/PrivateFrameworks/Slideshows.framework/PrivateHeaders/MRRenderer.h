...
@class MCMontage, MRContext, MRLayerParallelizer, MRRendererInternal, NSDictionary;
...
@interface MRRenderer : NSObject
{
    ...
    BOOL _needsToEnforceWindowServerCompositorPath;
    int mMode;
    int mOrientation;
    float mVolume;
    unsigned int _cgDisplay;
    MCMontage *mMontage;
...
@property(nonatomic) BOOL needsToEnforceWindowServerCompositorPath; // @synthesize needsToEnforceWindowServerCompositorPath=_needsToEnforceWindowServerCompositorPath;
@property(nonatomic, setter=setCGDisplay:) unsigned int cgDisplay; // @synthesize cgDisplay=_cgDisplay;
...
- (void)_enforceWindowServerCompositorPathIfNeeded;
