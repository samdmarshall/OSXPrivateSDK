...
#import "MMAuthenticatingPasswordSheetDelegate.h"
...
@class MMAuthenticatingPasswordSheet, MMCSCRecoveryController, MMModalDialog, MMTermsOfServiceController, NSButton, NSImageView, NSLock, NSTextField, NSWindow;

@interface MMAccountsService : MMService <MMAuthenticatingPasswordSheetDelegate, MMTermsOfServiceControllerDelegate, MMCSCSetupControllerDelegate, MMCSCRecoveryControllerDelegate, MMServicePreflightProtocol>
{
...
- (void)showSafariDeletionSheet:(id)arg1;
- (BOOL)safariHasDataToDelete;
