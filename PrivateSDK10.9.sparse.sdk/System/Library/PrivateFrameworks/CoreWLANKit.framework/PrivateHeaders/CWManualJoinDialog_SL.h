...
@class CWInterface, CWNetwork, CWNetworkProfile, NSArray, NSButton, NSPopUpButton, NSProgressIndicator, NSScrollView, NSSecureTextField, NSTableView, NSTextField, NSView, SFCertificateView;
...
+ (id)manualJoinDialogWithInterface:(id)arg1;
+ (id)autoJoinPromptWithInterface:(id)arg1 scanResults:(id)arg2;
...
- (void)associationThread;
- (void)associationCompleted:(id)arg1;
