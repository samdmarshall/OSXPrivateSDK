...
+ (void)initialize;
@property(nonatomic) id <ReadingListSegmentedControlDelegate> readingListSegmentedControlDelegate; // @synthesize readingListSegmentedControlDelegate=_readingListSegmentedControlDelegate;
