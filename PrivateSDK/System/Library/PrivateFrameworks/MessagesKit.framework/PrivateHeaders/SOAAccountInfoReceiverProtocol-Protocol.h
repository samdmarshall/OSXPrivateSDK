...
- (void)requestMessagesStatusForIDs:(NSArray *)arg1 withGUID:(NSString *)arg2;
- (void)requestFaceTimeStatusForIDs:(NSArray *)arg1 withGUID:(NSString *)arg2;
- (void)requestMessagesStatusForID:(NSString *)arg1 withGUID:(NSString *)arg2;
- (void)requestFaceTimeStatusForID:(NSString *)arg1 withGUID:(NSString *)arg2;
...
- (void)stopIDQueriesWithGUID:(NSString *)arg1;
@end
