...
@class NSArray, NSButton, NSImageView, NSMutableArray, NSSegmentedControl, NSTextField, NSTimer, NSView, PKPassBackView, PKPassDocumentView, PKPassFrontView, PKPassInfoTextField, PKPassPageDotView, PKPassScrollView;
