...
- (BOOL)globalCheckNegativeWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4;
- (BOOL)globalCheckWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4;
...
- (id)_correctionForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 tagger:(id)arg4 taggerIndex:(unsigned long long)arg5 dictionary:(id)arg6 language:(id)arg7 connection:(struct _PR_DB_IO *)arg8 keyEventData:(id)arg9 alternativeCorrection:(id *)arg10 isApostropheInsertion:(char *)arg11;
