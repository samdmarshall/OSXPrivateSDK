...
@class CWInterface, NSButton, NSPopUpButton, NSProgressIndicator, NSSecureTextField, NSTextField, NSView;
...
- (void)ibssCreate;
- (void)ibssCreateThread;
- (void)ibssCreationComplete:(id)arg1;
