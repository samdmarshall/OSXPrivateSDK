...
@property(retain, nonatomic) NSMutableData *incomingData; // @synthesize incomingData=_incomingData;
@property(retain, nonatomic) NSThread *readThread; // @synthesize readThread=_readThread;
