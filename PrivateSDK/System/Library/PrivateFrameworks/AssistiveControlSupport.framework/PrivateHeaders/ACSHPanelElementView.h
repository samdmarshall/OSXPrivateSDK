...
@class ACSHPanelElement, ACSHResizeHandlesView, NSArray, NSMutableArray;
...
- (struct CGRect)convertRectToDefaultSpace:(struct CGRect)arg1 fromSpace:(struct CGRect)arg2;
- (struct CGRect)convertRectFromDefaultSpace:(struct CGRect)arg1 toSpace:(struct CGRect)arg2;
