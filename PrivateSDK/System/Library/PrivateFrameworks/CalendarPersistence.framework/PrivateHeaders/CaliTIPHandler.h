...
+ (void)makeMessageAndReplyForOccurrence:(id)arg1 withAction:(int)arg2 withStatus:(int)arg3 placingInCalendar:(id)arg4 sendNotification:(BOOL)arg5;
+ (id)_findOrMakeMessageForEvent:(id)arg1 inContext:(id)arg2;
+ (BOOL)replyToInviteMessages:(id)arg1 withStatus:(int)arg2 placingInCalendar:(id)arg3 inContext:(id)arg4;
