...
@interface NFOfflineCoordinator : NSObject
{
    ...
    id <NFAccountProxyManager> _accountProxyManager;
}

@property(retain, nonatomic) id <NFAccountProxyManager> accountProxyManager; // @synthesize accountProxyManager=_accountProxyManager;
