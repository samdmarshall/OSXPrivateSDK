...
@interface CalAgentProxy : NSObject <CalendarAgent>
{
    struct dispatch_queue_s *_concurrent_queue;
    struct dispatch_queue_s *_serial_queue;
    struct dispatch_group_s *_delayForCoreDataGroup;
}
...
- (void)getPrincipalConnectedState:(id)arg1 reply:(CDUnknownBlockType)arg2;
...
- (void)refreshPrincipalWithObjectIDString:(id)arg1;
...
- (void)refreshSettingsChangedWithObjectID:(id)arg1;
- (void)accountDeletedWithObjectID:(id)arg1;
