...
@class ACAccount, ACAccountType, NSDictionary, NSNumber, NSString, NSURL;
...
- (void)promptUserForCredentialsWithAccount:(ACAccount *)arg1 withHandler:(void (^)(NSDictionary *, NSError *))arg2;
- (void)renewCredentialsForAccount:(ACAccount *)arg1 reason:(NSString *)arg2 completion:(void (^)(NSNumber *, NSError *))arg3;
- (void)renewCredentialsForAccount:(ACAccount *)arg1 force:(BOOL)arg2 reason:(NSString *)arg3 completion:(void (^)(NSNumber *, NSError *))arg4;
...
- (void)insertAccountDataclass:(NSString *)arg1 withHandler:(void (^)(id, NSError *))arg2;
...
- (void)saveAccount:(ACAccount *)arg1 pid:(NSNumber *)arg2 verify:(BOOL)arg3 dataclassActions:(NSDictionary *)arg4 completion:(void (^)(NSURL *, NSError *))arg5;
...
- (void)accountTypeForAccountWithIdentifier:(NSString *)arg1 handler:(void (^)(ACAccountType *, NSError *))arg2;
...
- (void)setNotificationsEnabledNum:(NSNumber *)arg1;
- (void)setClientBundleID:(NSString *)arg1 withHandler:(void (^)(NSNumber *, NSError *))arg2;
@end
