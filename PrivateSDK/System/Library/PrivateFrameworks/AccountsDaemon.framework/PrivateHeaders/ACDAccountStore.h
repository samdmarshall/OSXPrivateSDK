...
- (void)promptUserForCredentialsWithAccount:(id)arg1 withHandler:(CDUnknownBlockType)arg2;
...
- (void)_completeSave:(id)arg1 pid:(id)arg2 dataclassActions:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)insertAccountDataclass:(id)arg1 withHandler:(CDUnknownBlockType)arg2;
...
- (void)accountTypeForAccountWithIdentifier:(id)arg1 handler:(CDUnknownBlockType)arg2;
