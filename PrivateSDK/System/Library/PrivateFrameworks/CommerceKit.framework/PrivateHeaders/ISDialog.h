...
@class ISDialogButton, ISDialogOperation, NSArray, NSDictionary, NSLock, NSMutableDictionary, NSString;
...
@property(readonly) ISDialogOperation *dialogOperation; // @dynamic dialogOperation;
