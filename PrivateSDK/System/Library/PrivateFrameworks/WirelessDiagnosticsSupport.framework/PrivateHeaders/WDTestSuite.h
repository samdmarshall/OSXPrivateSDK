...
+ (id)getActive2GHzChannelGroupsSortedByWeight:(id)arg1 interface:(id)arg2;
+ (id)getActive5GHzChannelGroupsSortedByWeight:(id)arg1 interface:(id)arg2;
+ (id)getWeightedActive5GHzChannelGroups:(id)arg1 interface:(id)arg2;
+ (id)getWeightedActive2GHzChannelGroups:(id)arg1 interface:(id)arg2;
+ (id)getWeightedActive5GHzChannels:(id)arg1 interface:(id)arg2;
+ (id)getWeightedActive2GHzChannels:(id)arg1 interface:(id)arg2;
...
- (BOOL)quickPingAddress:(id)arg1 networkRegion:(id)arg2;
- (BOOL)pingAddress:(id)arg1 withNetworkRegion:(id)arg2;
