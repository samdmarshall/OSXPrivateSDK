...
@property(readonly, nonatomic) AVChatParticipant *localParticipant; // @synthesize localParticipant=_localParticipant;
...
@property(readonly, nonatomic) AVChatParticipant *initiatorParticipant; // @dynamic initiatorParticipant;
...
@property(readonly, nonatomic) AVChatFeature *ard;
@property(readonly, nonatomic) AVChatFeature *auxVideo;
@property(readonly, nonatomic) AVChatFeature *recorder;
