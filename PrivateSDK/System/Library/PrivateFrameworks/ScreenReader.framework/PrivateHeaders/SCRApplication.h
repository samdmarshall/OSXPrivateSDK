...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSString, NSURL, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRCThreadKey, SCRElement<SCRApplicationDirectChildProtocol>, SCREvent, SCRMenu, SCRUIElement;
...
@interface SCRApplication : SCRElement
{
    ...
    double _doNotEchoDesktopUntilTime;
    ...
    struct {
        double textSelectionDidChange;
        double valueDidChange;
    } _startCountTime;
    struct {
        unsigned long long textSelectionDidChange;
...
- (void)moveToSystemUIServerMenuExtras;
...
- (id)_requestWithItemDescription:(id)arg1;
