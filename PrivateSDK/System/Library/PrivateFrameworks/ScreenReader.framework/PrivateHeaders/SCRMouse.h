...
- (BOOL)button1Pressed;
- (BOOL)buttonPressed;
- (void)releaseMouseButton:(int)arg1 atPosition:(struct CGPoint)arg2 clickCount:(long long)arg3;
- (void)pressAndHoldDownMouseButton:(int)arg1 atPosition:(struct CGPoint)arg2 clickCount:(long long)arg3;
