...
@class NSMutableArray, NSString, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRMenuItem, SCRTable, SCRUIElement;
...
@interface SCRMenu : SCRElement
{
    ...
    long long _spotlightCount;
    SCRElement *_spotlightSearchField;
    long long _spotlightElementMaxIndex;
    long long _spotlightElementIndex;
    struct CGRect _spotlightElementsRect;
    struct CGRect _spotlightMenuItemRect;
    SCRUIElement *_spotlightUIBusyIndicator;
    NSString *_spotlightSearchString;
    double _lastSpotlightStatusTime;
    SCRCTargetSelectorTimer *_spotlightUpdateTimer;
    ...
    struct {
        ...
        unsigned int isSpotlight:1;
        unsigned int spotlightSetupDone:1;
        unsigned int spotlightWasBusy:1;
        unsigned int justOpened:1;
        unsigned int useSpotlightElementsRect:1;
...
- (void)_delayedFocusOnSpotlightSearchField:(id)arg1;
- (void)_delayedEchoSelection;
...
- (id)_uiMenuItems;
- (void)setIsSpotlightTimerEnabled:(BOOL)arg1;
- (struct CGRect)spotlightMenuItemRect;
- (void)_setupForSpotlight;
- (id)_spotlightElementAtIndex:(long long)arg1;
...
- (void)setIsSpotlightMenu:(BOOL)arg1;
- (BOOL)isMenuExtras;
