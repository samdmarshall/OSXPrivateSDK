...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSString, NSURL, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRCThreadKey, SCRElement<SCRApplicationDirectChildProtocol>, SCREvent, SCRMenu, SCROutputSharedFocusManager, SCRUIElement;
