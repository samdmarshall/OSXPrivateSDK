...
#import "CIMHigherOrderIMInfoProviderProtocol-Protocol.h"
...
- (void)enumerateConfirmedCandidatesWithDeletionIndex:(unsigned long long)arg1 usingHandler:(id)arg2;
- (void)enumerateConfirmedCandidatesAfterInsertedCandidate:(id)arg1 usingHandler:(id)arg2;
