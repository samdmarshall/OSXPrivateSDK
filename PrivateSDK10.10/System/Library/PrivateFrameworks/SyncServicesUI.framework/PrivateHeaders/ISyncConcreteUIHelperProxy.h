...
- (id)bundleCallWrapperIgnoringDefaultUIHelper:(void *)arg1 context:(struct WrapperStruct *)arg2;
- (id)bundleCallWrapper:(void *)arg1 context:(struct WrapperStruct *)arg2;
