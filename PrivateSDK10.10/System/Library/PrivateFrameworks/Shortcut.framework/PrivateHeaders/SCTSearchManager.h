...
@class NSButton, NSConditionLock, NSMutableArray, NSMutableDictionary, NSSearchField, NSStatusItem, NSString, NSTextField, NSTimer, NSWindow, SCTBackgroundView, SCTGRL, SCTGRLIndex, SCTMenuBarVisibilityManager, SCTMenuView, SCTTableView;
