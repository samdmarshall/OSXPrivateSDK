...
- (void)safari_animateScrollToEndWithVelocity:(double)arg1 completionHandler:(id)arg2;
- (void)safari_animateScrollToBeginningWithVelocity:(double)arg1 completionHandler:(id)arg2;
- (void)safari_animateScrollToPoint:(struct CGPoint)arg1 withVelocity:(double)arg2 completionHandler:(id)arg3;
- (void)scrollPageDown;
- (void)scrollPageUp;
- (void)scrollToEnd;
