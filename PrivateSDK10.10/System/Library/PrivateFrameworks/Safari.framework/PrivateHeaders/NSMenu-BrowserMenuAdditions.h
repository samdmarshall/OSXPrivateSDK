...
- (void)safari_addNewWindowAndTabMenuItemsWithTarget:(id)arg1 newWindowAction:(SEL)arg2 newTabAction:(SEL)arg3 useNewPrivateWindow:(BOOL)arg4;
...
- (id)safari_addItemWithTitle:(id)arg1 handler:(id)arg2;
