...
@property(copy, nonatomic) id performWithItemsBlock; // @synthesize performWithItemsBlock=_performWithItemsBlock;
...
- (void)showSharingServicePickerForURL:(id)arg1 window:(id)arg2 atBottomOfView:(id)arg3 performWithItemsHandler:(id)arg4;
