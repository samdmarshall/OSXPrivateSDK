...
@property(readonly, nonatomic) struct TopSite *topSite; // @synthesize topSite=_topSite;
...
- (void)enumerateDescendantsIncludingFolders:(BOOL)arg1 usingBlock:(id)arg2;
- (BOOL)_enumerateDescendantsIncludingFolders:(BOOL)arg1 usingBlock:(id)arg2;
