...
@class BrowserWindowControllerMac, DownloadFile, DownloadFileUnarchiver, NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSObject<OS_dispatch_queue>, NSOperationQueue, NSProgress, NSString, NSTimer, NSURL, NSURLDownload, NSURLRequest, NSURLResponse;
