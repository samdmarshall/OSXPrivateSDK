...
#import "EKUITokenFieldDelegate-Protocol.h"

@class EKEvent, NSMutableArray, NSMutableDictionary, NSObject<EKUIAttendeesViewController>, NSString, NSTextField<CalUIAutocompletingField>;
