...
#import "EKUILayoutItem-Protocol.h"
...
@interface EKUIGadgetContainer : NSObject <EKUILayoutItem>
{
    ...
    id _shouldDisplayDividerAboveBlock;
...
@property(copy) id shouldDisplayDividerAboveBlock; // @synthesize shouldDisplayDividerAboveBlock=_shouldDisplayDividerAboveBlock;
...
- (void)_subItem:(id)arg1 didSetExpandedState:(BOOL)arg2 willPerformAnimation:(BOOL)arg3 withCompletionBlock:(id)arg4;
- (void)mouseUpInContainerView:(id)arg1;
- (BOOL)isExpansionAllowed;
@property(readonly) BOOL isAnimating;
- (BOOL)_performExpansionAnimationIfNeeded:(BOOL)arg1;
- (void)setSpacing:(double)arg1 betweenTopSubitem:(id)arg2 bottomSubitem:(id)arg3 withCondition:(id)arg4;
- (void)setConditionalSpacing:(double)arg1 forKey:(id)arg2 withCondition:(id)arg3;
...
- (void)enumerateAllDescendantsDepthFirstUsingBlock:(id)arg1;
- (void)enumerateAllDescendantsBreadthFirstUsingBlock:(id)arg1;
- (void)enumerateSubcontainersUsingBlock:(id)arg1;
- (BOOL)itemIsAdjacentlyBelowVisibleDividerLine:(id)arg1;
- (BOOL)itemIsAdjacentToExpandedContainer:(id)arg1;
- (void)enumerateCurrentlyDisplayedItemsWithNeighborsUsingBlock:(id)arg1;
...
- (void)setExpanded:(BOOL)arg1 withCompletionBlock:(id)arg2;
