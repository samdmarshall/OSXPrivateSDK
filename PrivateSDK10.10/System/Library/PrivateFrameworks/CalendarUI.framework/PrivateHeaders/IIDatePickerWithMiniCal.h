...
@property(retain) IIDatePickerPanel *calPanel; // @synthesize calPanel=_calPanel;
...
@property id <IIDatePickerWithMiniCalDelegate> delegate; // @synthesize delegate=_delegate;
