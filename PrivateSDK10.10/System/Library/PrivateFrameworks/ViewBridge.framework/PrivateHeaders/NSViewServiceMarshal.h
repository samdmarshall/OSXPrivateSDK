...
@class NSAccessibilityRemoteUIElement, NSColor, NSLayoutConstraint, NSMutableArray, NSProxy<NSXPCProxyCreating>, NSResponder, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSViewService, NSWindow, NSXPCConnection, NSXPCInterface;
...
- (void)requestResize:(struct CGSize)arg1 transaction:(id)arg2 animate:(BOOL)arg3 completion:(id)arg4;
...
- (void)beginRemoteSheet:(id)arg1 modalForWindow:(id)arg2 size:(struct CGSize)arg3 isCritical:(BOOL)arg4 withReply:(id)arg5;
