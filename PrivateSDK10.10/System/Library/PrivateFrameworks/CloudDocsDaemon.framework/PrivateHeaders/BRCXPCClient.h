...
- (void)getTheoriticalContainerURLWithID:(id)arg1 forPID:(int)arg2 reply:(id)arg3;
- (void)getTheoriticalContainerURLWithID:(id)arg1 reply:(id)arg2;
...
- (void)getPrimaryiCloudAccountStatus:(id)arg1;
