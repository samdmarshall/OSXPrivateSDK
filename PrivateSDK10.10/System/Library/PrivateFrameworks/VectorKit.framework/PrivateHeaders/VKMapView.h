...
@class GEOMapRegion, GGLDisplayLink, MDDisplayLayer, NSArray, NSMutableArray, NSString, VKAnimation, VKClassicGlobeCanvas, VKLabelMarker, VKMapCanvas, VKMemoryObserver, VKPolylineOverlayPainter, VKStyleManager;
