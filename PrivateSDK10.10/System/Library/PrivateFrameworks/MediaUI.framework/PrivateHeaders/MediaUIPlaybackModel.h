...
- (void)setDisplaysClosedCaptions:(BOOL)arg1 completionHandler:(id)arg2;
- (void)setDisplaysSubtitles:(BOOL)arg1 completionHandler:(id)arg2;
- (void)selectAudioLocale:(id)arg1 completionHandler:(id)arg2;
- (void)selectSubtitleLocale:(id)arg1 completionHandler:(id)arg2;
- (void)seekToTime:(double)arg1 toleranceBefore:(double)arg2 toleranceAfter:(double)arg3 completionHandler:(id)arg4;
- (void)setRate:(double)arg1 completionHandler:(id)arg2;
- (void)setVolume:(double)arg1 completionHandler:(id)arg2;
