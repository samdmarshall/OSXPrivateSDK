...
- (void)setModifyOwnershipUsingBlock:(id)arg1;
- (void)setMaskExpressions:(id)arg1;
- (void)setScriptRoot:(id)arg1;
- (void)setMapBaselineNamesUsingBlock:(id)arg1;
...
- (BOOL)_writeBomToFile:(id)arg1 error:(id *)arg2 modifyOwnershipUsingBlock:(id)arg3;
- (void)_adjustOwnershipOnPath:(id)arg1 inBom:(id)arg2 usingBlock:(id)arg3;
...
- (void)_setModifyOwnershipUsingBlock:(id)arg1;
- (void)_setMaskExpressions:(id)arg1;
- (void)_setScriptRoot:(id)arg1;
- (void)_setMapBaselineNamesUsingBlock:(id)arg1;
