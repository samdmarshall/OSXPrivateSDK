...
- (void)finishSandboxRemovalWithCompletionHandler:(id)arg1;
- (void)requestFreeSpace:(unsigned long long)arg1 onVolume:(id)arg2 forInstallingRequest:(id)arg3 appStoreOnly:(BOOL)arg4 notifyOn:(struct dispatch_queue_s *)arg5 withBlock:(id)arg6;
