...
- (void)showSheetForWindow:(id)arg1 title:(id)arg2 message:(id)arg3 defaultButtonTitle:(id)arg4 defaultKeyEquivalent:(id)arg5 alternateButtonTitle:(id)arg6 alternateKeyEquivalent:(id)arg7 otherButtonTitle:(id)arg8 otherKeyEquivalent:(id)arg9 andHelpHandler:(id)arg10 completionHandler:(void)arg11;
