...
- (void)beginModalSheetWithParentWindow:(id)arg1 title:(id)arg2 message:(id)arg3 defaultButtonTitle:(id)arg4 alternateButtonTitle:(id)arg5 completionHandler:(id)arg6;
- (void)dealloc;
- (id)init;
