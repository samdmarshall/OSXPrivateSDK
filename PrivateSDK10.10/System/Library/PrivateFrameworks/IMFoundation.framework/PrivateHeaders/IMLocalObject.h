...
+ (struct dispatch_queue_s *)_imLocalObjectQueue;
- (id)description;
- (void)invalidate;
...
- (id)initWithTarget:(id)arg1 connection:(struct _xpc_connection_s *)arg2 protocol:(id)arg3 offMainThread:(BOOL)arg4;
