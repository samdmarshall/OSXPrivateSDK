...
- (void)unEnrollDeviceForSMSRelay:(id)arg1 account:(id)arg2;
- (void)enrollDeviceForSMSRelay:(id)arg1 account:(id)arg2;
...
- (void)sendPlayedReceiptForMessage:(id)arg1 toChatID:(id)arg2 identifier:(id)arg3 style:(unsigned char)arg4 account:(id)arg5;
...
- (void)removePersonInfo:(id)arg1 chatID:(id)arg2 identifier:(id)arg3 style:(unsigned char)arg4 account:(id)arg5;
...
- (void)removeChatID:(id)arg1 identifier:(id)arg2 style:(unsigned char)arg3 account:(id)arg4;
- (void)leaveChatID:(id)arg1 identifier:(id)arg2 style:(unsigned char)arg3 account:(id)arg4;
- (void)joinChatID:(id)arg1 handleInfo:(id)arg2 identifier:(id)arg3 style:(unsigned char)arg4 groupID:(id)arg5 joinProperties:(id)arg6 account:(id)arg7;
...
- (void)silenceChat:(id)arg1 untilDate:(id)arg2;
- (void)chat:(id)arg1 updateDisplayName:(id)arg2;
- (void)chat:(id)arg1 updateProperties:(id)arg2;
- (void)cleanupAttachments;
- (void)loadAttachmentsForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 chatID:(id)arg4 queryID:(id)arg5;
- (void)loadFrequentRepliesForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 limit:(unsigned long long)arg4 chatID:(id)arg5 queryID:(id)arg6;
- (void)updateUnformattedID:(id)arg1 forBuddyID:(id)arg2 onService:(id)arg3;
- (void)markSavedForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 message:(id)arg4;
- (void)markSavedForMessageGUID:(id)arg1;
- (void)markPlayedForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 message:(id)arg4;
- (void)markPlayedForMessageGUID:(id)arg1;
- (void)storeItem:(id)arg1 inChatGUID:(id)arg2;
