...
- (void).cxx_destruct;
- (id)description;
- (void)getRecoverySystemInfo:(id)arg1;
- (BOOL)ensureRecovery:(id)arg1 chunkkList:(id)arg2 diagnostics:(id)arg3 handlingProgress:(id)arg4 withCompletionBlock:(void)arg5;
- (BOOL)convertDiskToFDEWithUsers:(id)arg1 recoveryKey:(id)arg2 handlingProgress:(id)arg3 withCompletionBlock:(void)arg4;
- (BOOL)convertToCoreStorage:(BOOL)arg1 handlingProgress:(id)arg2 withCompletionBlock:(void)arg3;
- (BOOL)ensureRecovery:(id)arg1 chunkkList:(id)arg2 handlingProgress:(id)arg3 withCompletionBlock:(void)arg4;
- (BOOL)removeDiskHandlingProgress:(id)arg1 withCompletionHandler:(void)arg2;
- (BOOL)splitToSize:(unsigned long long)arg1 newDiskRole:(id)arg2 name:(id)arg3 caseSensitive:(BOOL)arg4 password:(id)arg5 handlingProgress:(id)arg6 withCompletionBlock:(void)arg7;
- (BOOL)repairWithProgressHandler:(id)arg1 withCompletionBlock:(void)arg2;
- (BOOL)verifyWithProgressHandler:(id)arg1 withCompletionBlock:(void)arg2;
- (BOOL)secureEraseWithLevel:(int)arg1 handlingProgress:(id)arg2 withCompletionBlock:(void)arg3;
- (BOOL)eraseToRole:(id)arg1 name:(id)arg2 caseSensitive:(BOOL)arg3 password:(id)arg4 handlingProgress:(id)arg5 withCompletionBlock:(void)arg6;
- (BOOL)eraseHandlingProgress:(id)arg1 withCompletionHandler:(void)arg2;
- (BOOL)canBeErasedToRole:(id)arg1;
- (BOOL)ejectWithCompletionBlock:(id)arg1;
- (BOOL)mountWithCompletionBlock:(id)arg1;
- (BOOL)unmountWithCompletionBlock:(id)arg1;
- (BOOL)enableJournalingWithCompletionBlock:(id)arg1;
- (BOOL)enablePermissionsWithCompletionBlock:(id)arg1;
- (BOOL)setDiskIcon:(id)arg1 withCompletionBlock:(id)arg2;
- (BOOL)rename:(id)arg1 withCompletionBlock:(id)arg2;
- (BOOL)blessWithCompletionBlock:(id)arg1;
- (BOOL)setBootWithCompletionBlock:(id)arg1;
- (BOOL)canBoot;
- (void)expireCache;
- (void)expireCacheWithCompletionBlock:(id)arg1;
- (BOOL)canResize;
