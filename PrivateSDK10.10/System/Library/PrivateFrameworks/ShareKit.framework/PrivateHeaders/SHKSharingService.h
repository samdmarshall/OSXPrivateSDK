...
@interface SHKSharingService : NSObject
{
    ...
    id _restoreWindowStateBlock;
    id __cancelExtensionKillTimer;
...
+ (id)sharingServiceWithTitle:(id)arg1 image:(id)arg2 alternateImage:(id)arg3 handler:(id)arg4;
+ (id)sharingServiceNamed:(id)arg1;
@property __weak NSWindow *sourceWindow; // @synthesize sourceWindow=_sourceWindow;
@property(copy, nonatomic) id _cancelExtensionKillTimer; // @synthesize _cancelExtensionKillTimer=__cancelExtensionKillTimer;
@property(copy, nonatomic) id restoreWindowStateBlock; // @synthesize restoreWindowStateBlock=_restoreWindowStateBlock;
...
- (void)serviceDoneWithStatus:(unsigned long long)arg1 error:(id)arg2 parameters:(id)arg3 outputItems:(id)arg4 completion:(id)arg5;
- (void)serviceDoneWithStatus:(unsigned long long)arg1 error:(id)arg2 parameters:(id)arg3 outputItems:(id)arg4;
- (void)requestCompletedWithItems:(id)arg1 completion:(id)arg2;
...
- (id)executeHandler:(SEL)arg1 onQueue:(id)arg2 onTimeoutInSeconds:(void)arg3;
- (id)executeHandler:(SEL)arg1 onTimeoutInSeconds:(id)arg2;
- (id)appID;
