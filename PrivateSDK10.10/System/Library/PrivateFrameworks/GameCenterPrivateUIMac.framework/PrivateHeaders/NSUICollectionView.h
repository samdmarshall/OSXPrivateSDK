...
@class CALayer, NSArray, NSCollectionDocumentView, NSCollectionViewData, NSCollectionViewLayout, NSCollectionViewUpdate, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<NSCollectionViewDataSource>, NSObject<NSUICollectionViewDelegate>, NSSet;
