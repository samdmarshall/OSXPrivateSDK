...
#import "SMCustomize_Client_Delegate-Protocol.h"
...
@property(copy) id connectionErrorHandler; // @synthesize connectionErrorHandler=_connectionErrorHandler;
...
@property(copy) id fdeConvertHandler; // @synthesize fdeConvertHandler=_fdeConvertHandler;
@property BOOL targetCanBecomeFDE; // @synthesize targetCanBecomeFDE=_targetCanBecomeFDE;
@property(copy) id cancelHandler; // @synthesize cancelHandler=_cancelHandler;
...
- (void)setupForSystem:(id)arg1 withCompletionHandler:(id)arg2;
