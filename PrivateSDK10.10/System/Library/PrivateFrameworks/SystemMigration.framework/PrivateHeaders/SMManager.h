...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, PKDeferredInstallManager, SMAutoLoaderServer, SMMigrateEngine;
...
@interface SMManager : NSObject
{
    ...
    NSObject<OS_dispatch_source> *_throttlingSuppressTimer;
...
@property(retain) NSObject<OS_dispatch_source> *throttlingSuppressTimer; // @synthesize throttlingSuppressTimer=_throttlingSuppressTimer;
...
- (void)waitForSpotlightToIndex:(id)arg1;
