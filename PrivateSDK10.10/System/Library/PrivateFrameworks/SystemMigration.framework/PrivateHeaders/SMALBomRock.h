...
@class NSDate, NSDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_dispatch_source>, NSObject<SMSlingShotDelegate>, NSSet, NSString;
