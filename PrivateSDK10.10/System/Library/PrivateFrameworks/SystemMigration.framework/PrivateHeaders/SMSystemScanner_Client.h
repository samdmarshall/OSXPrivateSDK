...
#import "MigratableEventsListener-Protocol.h"

@class NSArray, NSHashTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSPredicate, NSSet, NSXPCConnection, NSXPCInterface, SMSystem_Client;
