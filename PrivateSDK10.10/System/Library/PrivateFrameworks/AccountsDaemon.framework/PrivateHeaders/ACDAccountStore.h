...
@class ACDAccessPluginManager, ACDAccountStoreFilter, ACDAuthenticationDialogManager, ACDAuthenticationPluginManager, ACDClient, ACDClientAuthorizationManager, ACDDatabase, ACDDataclassOwnersManager, ACDFakeRemoteAccountStoreSession, ACIDSProxy, NSMutableArray, NSString;
...
@property(retain) ACIDSProxy *acIDSProxy; // @synthesize acIDSProxy=_acIDSProxy;
