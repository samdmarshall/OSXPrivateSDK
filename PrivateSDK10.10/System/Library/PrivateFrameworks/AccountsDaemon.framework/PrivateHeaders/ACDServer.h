...
@class ACDAccessPluginManager, ACDAuthenticationDialogManager, ACDAuthenticationPluginManager, ACDDataclassOwnersManager, ACIDSProxy, NSMutableArray, NSMutableDictionary, NSString, NSXPCListener;
...
@property(retain, nonatomic) ACIDSProxy *acIDSProxy; // @synthesize acIDSProxy=_acIDSProxy;
