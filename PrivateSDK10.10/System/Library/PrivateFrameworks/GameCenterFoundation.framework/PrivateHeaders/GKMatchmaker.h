...
@property(copy, nonatomic) id nearbyPlayerIDHandler; // @synthesize nearbyPlayerIDHandler=_nearbyPlayerIDHandler;
...
@property(copy, nonatomic) id recipientResponseHandler; // @synthesize recipientResponseHandler=_recipientResponseHandler;
