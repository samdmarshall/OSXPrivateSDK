...
@interface FRStoreViewController : NSViewController
{
    ...
    id _purchaseAnimationHandler;
    id _pageLoadingProgressHandler;
...
@property(copy) id pageLoadingProgressHandler; // @synthesize pageLoadingProgressHandler=_pageLoadingProgressHandler;
@property BOOL showLinearLoadingProgress; // @synthesize showLinearLoadingProgress=_showLinearLoadingProgress;
@property(copy) id purchaseAnimationHandler; // @synthesize purchaseAnimationHandler=_purchaseAnimationHandler;
