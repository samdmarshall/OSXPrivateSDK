...
#import "EKProtocolEventOccurrence-Protocol.h"
...
- (id)expandAndTranslateEventsFromDate:(id)arg1 toDate:(id)arg2 translateBlock:(id)arg3 sortSelector:(void)arg4;
...
- (id)checkAndPromptForConflictsWithStatus:(int)arg1 conflictDecisionBlock:(id)arg2;
- (void)createExceptionsAndMessages:(id)arg1 forConflicts:(id)arg2 sender:(id)arg3;
- (BOOL)replyWithStatus:(int)arg1 fromMessage:(id)arg2 putInCalendar:(id)arg3 conflictDecisionBlock:(id)arg4 handledMessage:(void)arg5;
...
- (void)importiCalendarComponent:(id)arg1 occurrences:(id)arg2 fromDocument:(id)arg3 inCalendar:(id)arg4 options:(unsigned long long)arg5 deletionBlock:(id)arg6;
