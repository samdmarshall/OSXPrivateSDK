...
+ (BOOL)replyToInviteMessages:(id)arg1 withStatus:(int)arg2 placingInCalendar:(id)arg3 inContext:(id)arg4 conflictDecisionBlock:(id)arg5 doAsyncWithCompletionBlock:(void)arg6;
+ (void)replyToMessage:(id)arg1 withStatus:(int)arg2 placingInCalendar:(id)arg3 conflictDecisionBlock:(id)arg4 doAsyncWithCompletionBlock:(void)arg5;
+ (void)removeMessages:(id)arg1 doAsyncWithCompletionBlock:(id)arg2;
+ (void)removeMessages:(id)arg1;
+ (void)acknowledgeMessage:(id)arg1 pendingMessages:(id)arg2 doAsyncWithCompletionBlock:(id)arg3;
+ (void)acknowledgeMessage:(id)arg1 pendingMessages:(id)arg2;
+ (void)acknowledgeMessages:(id)arg1 pendingMessages:(id)arg2 doAsyncWithCompletionBlock:(id)arg3;
...
+ (id)iTIPCompletionBlockForPrincipal:(SEL)arg1 context:(id)arg2;
