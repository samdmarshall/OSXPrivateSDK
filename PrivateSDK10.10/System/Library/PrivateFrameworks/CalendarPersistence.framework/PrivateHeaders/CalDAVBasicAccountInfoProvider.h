...
+ (void)initialize;
@property(retain) NSString *cachedClientToken; // @synthesize cachedClientToken=_cachedClientToken;
...
- (id)initWithUser:(id)arg1 password:(id)arg2 principalURL:(id)arg3 accountID:(id)arg4 acAccountID:(id)arg5 objectID:(id)arg6;
