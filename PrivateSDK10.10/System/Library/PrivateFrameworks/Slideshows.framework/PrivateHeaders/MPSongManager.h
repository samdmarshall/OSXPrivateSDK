...
- (id)descriptionForSongsAtPaths:(id)arg1 progressCallback:(void *)arg2 context:(void *)arg3;
- (id)descriptionForSongAtPath:(id)arg1 progressCallback:(void *)arg2 context:(void *)arg3;
- (id)qt32Server;
- (void)dealloc;
- (id)init;
