...
#import "OKDocumentDelegate-Protocol.h"
#import "OKDocumentMediaItemLookupDelegate-Protocol.h"

@class MPDocument, NSArray, NSDictionary, NSMutableDictionary, NSString, NSURL, OKDocument, OMSlideshowTheme;
...
- (unsigned long long)_opusExportMovieToURL:(id)arg1 options:(id)arg2 progressHandler:(id)arg3 resultHandler:(void)arg4;
- (unsigned long long)_marimbaExportMovieToURL:(id)arg1 options:(id)arg2 progressHandler:(id)arg3 resultHandler:(void)arg4;
- (unsigned long long)exportMovieToURL:(id)arg1 options:(id)arg2 progressHandler:(id)arg3 resultHandler:(void)arg4;
...
- (void)setCustomDuration:(double)arg1 forItemsAtIndices:(id)arg2 completionHandler:(id)arg3;
...
- (void)removeItemsAtIndices:(id)arg1 completionHandler:(id)arg2;
- (BOOL)canRemoveItemsAtIndices:(id)arg1;
- (void)insertMediaAssets:(id)arg1 atIndex:(unsigned long long)arg2 completionHandler:(id)arg3;
- (BOOL)canInsertMediaAssetsAtIndex:(unsigned long long)arg1;
- (void)insertText:(id)arg1 atIndex:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)insertText:(id)arg1 atIndex:(unsigned long long)arg2;
- (BOOL)canInsertTextAtIndex:(unsigned long long)arg1;
- (void)moveItemsAtIndices:(id)arg1 toIndex:(unsigned long long)arg2 completionHandler:(id)arg3;
...
- (void)_removeMediaAssetsAtIndices:(id)arg1 completionHandler:(id)arg2;
- (void)_insertMediaAssets:(id)arg1 atIndex:(unsigned long long)arg2 completionHandler:(id)arg3;
- (void)_moveMediaAssetsAtIndices:(id)arg1 toIndex:(unsigned long long)arg2 completionHandler:(id)arg3;
- (BOOL)_hasTitle;
...
- (void)saveToURL:(id)arg1 completionHandler:(id)arg2;
