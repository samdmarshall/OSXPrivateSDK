...
#import "SSInputEventConsumer-Protocol.h"

@class MessageTracerInfo, NSArray, NSDate, NSImage, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_source>, NSObject<SSDragDelegate>, NSObject<SSSessionDelegate>, NSRecursiveLock, NSSet, NSString, NSThread, NSTimer, SSAddress, SSConnectionOptions, SSFrameBuffer, SSScreenConfiguration, SSScreenInfo, SenderThread;
